...
export type GetMoveAggregateType<T extends MoveAggregateArgs> = {
    [P in keyof T & keyof AggregateMove]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateMove[P]> : Prisma.GetScalarType<T[P], AggregateMove[P]>;
};
...
type GetMoveGroupByPayload<T extends MoveGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<MoveGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof MoveGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], MoveGroupByOutputType[P]> : Prisma.GetScalarType<T[P], MoveGroupByOutputType[P]>;
}>>;
export type MoveWhereInput = {
    ...
    playerId?: Prisma.StringFilter<"Move"> | string;
    fromSquare?: Prisma.StringFilter<"Move"> | string;
    toSquare?: Prisma.StringFilter<"Move"> | string;
...
export type MoveScalarWhereWithAggregatesInput = {
    ...
    playerId?: Prisma.StringWithAggregatesFilter<"Move"> | string;
    fromSquare?: Prisma.StringWithAggregatesFilter<"Move"> | string;
    toSquare?: Prisma.StringWithAggregatesFilter<"Move"> | string;
...
export type MoveOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "gameId" | "playerId" | "fromSquare" | "toSquare" | "createdAt", ExtArgs["result"]["move"]>;
...
export type MoveCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<MoveFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MoveDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['Move'];
        meta: {
            name: 'Move';
        };
    };
     ...
     * })
    **/
    count<T extends MoveCountArgs>(args?: Prisma.Subset<T, MoveCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], MoveCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends MoveGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, MoveGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMoveGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface MoveFieldRefs {
    ...
    readonly playerId: Prisma.FieldRef<"Move", 'String'>;
    readonly fromSquare: Prisma.FieldRef<"Move", 'String'>;
    readonly toSquare: Prisma.FieldRef<"Move", 'String'>;
